            ...
            >
              {pages.map((page) => (
                <MenuItem
                  ...
                  sx={{
                    backgroundColor: isActive(`/${page.toLowerCase().replace(' ', '')}`) ? 'rgba(0, 0, 0, 0.1)' : 'inherit',
                  }}
                >
                  <Link to={page === 'Home' ? '/' : `/${page.toLowerCase().replace(' ', '')}`} style={{ textDecoration: 'none' }}>
                    <Typography
                      sx={{
                        textAlign: 'center',
                        color: isActive(`/${page.toLowerCase().replace(' ', '')}`) ? 'primary.main' : 'inherit',
                      }}
                    >
                      {page}
                    </Typography>
          ...
          <Box sx={{ flexGrow: 1, display: { xs: 'none', md: 'flex' }, ml: 2 }}>
            {pages.map((page) => (
              <Button
                ...
                sx={{
                  my: 2,
                  color: isActive(`/${page.toLowerCase().replace(' ', '')}`) ? 'primary.main' : 'black',
                  display: 'block',
                  backgroundColor: isActive(`/${page.toLowerCase().replace(' ', '')}`) ? 'rgba(0, 0, 0, 0.1)' : 'inherit',
                  '&:hover': {
